    ...
    >
      ...
      <div className="flex items-center gap-2 px-2 h-[52px] flex justify-between items-center">
        ...
        >
          ...
          <span className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2 py-1 text-xs text-white bg-gray-900 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 font-semibold">
            Close sidebar
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-0.5 text-[#8F8F8F] mb-3">
        <div className="h-[32px] gap-0.5 flex items-center justify-start py-[6px] px-[16px] rounded-lg text-sm cursor-pointer">
          <span>Projekte</span>
      ...
      <div className="mt-auto px-[6px] w-full h-[123.14px]">
        <div className="h-[51.14px] w-full flex items-center gap-2 px-[6px] pt-[6px] pr-[10px] pb-[6px] pl-[8px] rounded-lg hover:bg-[#0000000F] cursor-pointer">
          ...
          <div className="flex flex-col min-w-0">
            ...
            <span className="text-xs text-[#8F8F8F] truncate">
              QAVION RECRUITING
            </span>
          </div>
        </div>
        ...
        <div className="m-4 mt-2 mx-auto">
          <button
            className="w-[228px] py-0 px-4 text-xs h-9 mx-auto border border-[#0d0d0d1a] rounded-2xl text-sm bg-[#FFFFFF] text-[#0D0D0D]
