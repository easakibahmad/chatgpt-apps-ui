...
const appDetails: Record<string, {
        ...
        content: (
          <div className="absolute inset-3 flex flex-col">
            <div className="bg-white/90 rounded-lg px-2 py-1.5 text-[10px] text-gray-700 self-start mb-2 shadow-sm">
              <span className="font-semibold text-gray-900">@Ace Knowledge Graph</span> Help me understand React ecosystem.
            </div>
              ...
              <div className="flex-1 relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-full h-full">
                    {/* Central node */}
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-[8px] font-medium">React</div>
                    {/* Surrounding nodes */}
                    <div className="absolute left-1/4 top-1/4 w-6 h-6 bg-teal-400 rounded-full flex items-center justify-center text-white text-[6px]">Hooks</div>
                    <div className="absolute right-1/4 top-1/4 w-6 h-6 bg-purple-400 rounded-full flex items-center justify-center text-white text-[6px]">JSX</div>
                    <div className="absolute left-1/4 bottom-1/4 w-6 h-6 bg-orange-400 rounded-full flex items-center justify-center text-white text-[6px]">State</div>
                    <div className="absolute right-1/4 bottom-1/4 w-6 h-6 bg-green-400 rounded-full flex items-center justify-center text-white text-[6px]">Props</div>
                  </div>
                </div>
              </div>
          ...
          <div className="absolute inset-3 flex flex-col">
            ...
            <div className="flex-1 bg-white rounded-xl p-3 shadow-sm flex flex-col">
              <div className="flex-1 relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-full h-full">
                    <div className="absolute left-1/2 top-1/3 -translate-x-1/2 w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-[8px] font-medium">React</div>
                    ...
                    <svg className="absolute inset-0 w-full h-full" style={{zIndex: -1}}>
                      <line x1="50%" y1="33%" x2="20%" y2="20%" stroke="#ddd" strokeWidth="1"/>
                      <line x1="50%" y1="33%" x2="80%" y2="25%" stroke="#ddd" strokeWidth="1"/>
                      <line x1="50%" y1="33%" x2="30%" y2="70%" stroke="#ddd" strokeWidth="1"/>
                    </svg>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-2 bg-gray-50 rounded p-2">
                ...
                <p className="text-[7px] text-gray-500 mt-0.5">React is a JavaScript library for building user interfaces using a component-based architecture and a virtual DOM.</p>
              </div>
            </div>
          </div>
        )
        ...
        content: (
          <div className="absolute inset-3 flex flex-col">
            ...
            <div className="flex-1 bg-white rounded-xl p-3 shadow-sm flex flex-col">
              ...
              <div className="mt-2 bg-gray-50 rounded p-2">
                <p className="text-[9px] font-medium text-gray-800">React and Redux</p>
                <p className="text-[7px] text-gray-500 mt-0.5">React commonly integrates with Redux through bindings like react-redux, allowing React components to subscribe to global state and dispatch actions efficiently.</p>
              </div>
            </div>
          </div>
        )
  ...
  "tarot": {
    ...
    longDescription: "Starte deine Tarot-Lesung direkt in ChatGPT. Bitte KI Tarot, digitale Tarotkarten zu mischen, einen Drei-Karten-Spread zu legen und klare, private Wahrsage-Einblicke zu liefern - ohne Werbung oder Wartezeiten.",
    howToUse: "So verwendest du Tarot in ChatGPT",
    steps: [
      "Verbinden: Verbinde die Tarot-App mit ChatGPT....",
    ],
    ...
    icon: (
      <div className="w-16 h-16 rounded-2xl bg-gray-900 flex items-center justify-center">
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
          <path d="M12 2l2.4 7.2H22l-6 4.8 2.4 7.2L12 16.8l-6.4 4.4 2.4-7.2-6-4.8h7.6L12 2z" fill="#4A90A4"/>
          <path d="M12 5l1.5 4.5H18l-3.7 3 1.5 4.5-3.8-2.7-3.8 2.7 1.5-4.5-3.7-3h4.5L12 5z" fill="#FFD700"/>
        </svg>
      </div>
    ),
    screenshots: [
      { 
        ...
        content: (
          <div className="absolute inset-3 flex flex-col">
            <div className="bg-white/90 rounded-lg px-2 py-1.5 text-[10px] text-gray-700 self-start mb-2 shadow-sm">
              <span className="font-semibold text-gray-900">@Tarot</span> I want clarity on my life now and what&apos;s ahead.
            </div>
            <div className="flex-1 bg-gray-900 rounded-xl p-3 flex flex-col items-center justify-center">
              ...
              <p className="text-white/70 text-[8px] text-center mb-2">Focus on your life path and draw three cards for clarity</p>
              <button className="px-3 py-1 bg-teal-600 text-white text-[8px] rounded-full">Start drawing cards</button>
            </div>
          </div>
        )
      },
        ...
        content: (
          <div className="absolute inset-3 flex flex-col">
            ...
            <div className="flex-1 bg-gray-900 rounded-xl p-3 flex flex-col items-center justify-center">
              ...
              <p className="text-white/70 text-[8px] text-center mb-1">Please imagine your question in your mind.</p>
              <p className="text-white/50 text-[7px] text-center mb-2">Currently interpreting your question...</p>
              <button className="px-3 py-1 bg-teal-600 text-white text-[8px] rounded-full">Read your cards</button>
            </div>
          </div>
        )
      },
          ...
          <div className="absolute inset-3 flex flex-col">
            ...
            <div className="flex-1 bg-gray-900 rounded-xl p-2 flex flex-col">
              ...
              <div className="bg-gray-800 rounded p-2 flex-1">
                <p className="text-white text-[8px] font-medium mb-1">Your Life Path Reading</p>
                <p className="text-amber-400 text-[7px] mb-1">Where You&apos;ve Been—Page of Swords (upright)</p>
                <p className="text-white/60 text-[6px] leading-tight">You&apos;ve come out of a phase defined by curiosity, questioning, and mental alertness. You were learning fast, gathering information, testing ideas, and watching carefully before acting. This suggests a period of</p>
              </div>
            </div>
          </div>
        )
  ...
  "adobe-photoshop": {
    ...
    longDescription: "Bearbeite und verbessere deine Bilder direkt in ChatGPT mit Adobe Photoshop. Wende Filter an, passe Farben an, entferne Hintergründe und mehr mit einfachen Textbefehlen.",
...
const defaultAppDetail = {
  ...
  longDescription: "Diese App integriert sich mit ChatGPT, um erweiterte Funktionen bereitzustellen.",
  category: "Produktivität",
  icon: (
